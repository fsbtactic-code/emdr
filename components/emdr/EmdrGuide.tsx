  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed left-4 md:left-6 top-[136px] md:top-[160px] z-40 p-3 rounded-2xl bg-white/[0.06] hover:bg-white/10 transition-all duration-300 backdrop-blur-md border border-white/[0.08] shadow-lg ${isOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
      >
        <HelpCircle size={24} className="text-white/60" />
      </button>
